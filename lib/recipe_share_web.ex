defmodule RecipeShareWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: RecipeShareWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/recipe_share_web/templates",
        namespace: RecipeShareWeb
  ...
  defp view_helpers do
    quote do
      ...
      import RecipeShareWeb.LiveHelpers
