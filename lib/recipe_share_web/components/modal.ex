defmodule RecipeShareWeb.Components.Modal do
  ...
  def render(assigns) do
    ...
    <div
      ...
      x-cloak
    >
      <div class="flex justify-center items-end text-center min-h-screen bg-white bg-opacity-50 px-4 sm:block sm:p-0">
        <div
          x-show="open"
          x-cloak
        ...
        <div
          ...
          class="inline-block align-bottom bg-blueGray-300 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:align-middle md:max-w-xl sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline"
          x-transition:enter="ease-out duration-<%= @enter_duration %>"
        ...
        >
          <div class="modal-content bg-white">
            ...
            >
              <div class="flex justify-between py-2 px-4 w-full items-center">
                <h3 class="text-lg leading-6 font-medium text-blueGray-200" id="modal-headline">{{ @title }}</h3>
